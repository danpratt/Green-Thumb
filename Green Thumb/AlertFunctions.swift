    ...
    if isFirstLaunch {
        ...
        do {
            ...
            if results.count > 0 {
                ...
                print("plant pulled from core data \(String(describing: gardeningFrequecy!.plantName))")
                print("freqnecy pulled from core data \(String(describing: gardeningFrequecy!.gardeningLevel))")
